              ...
              <CardBody background={isReedem ? "linear-gradient(to right, #78ffd6, #a8ff78)" : null}>
                {isReedem ?
                  <div>
                    ...
                    <Button onClick={handleConfirmationMessage} propsButton={{ ...propsButton, margin: "0rem 2rem 3rem", paddingText: queryMatch.matches ? "0 4rem 0 4rem" : "0 0 0 0.5rem", color: "#009a00", }} tittle={ error ? "CONTINUE" : "TRY AGAIN"}></Button>
                  </div>
                  :
                  <div>
                    <CardDivIcon>
