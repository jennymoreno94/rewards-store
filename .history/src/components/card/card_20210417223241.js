...
export function Card() {
  ...
  const propsButton = {
    ...
    fontSize: "18px",
    color: "#616161",
    marginText: queryMatch.matches ? "1.5rem 0 1.5rem 4rem" : "1.5rem 0 1.5rem 4rem",
              ...
              <CardBody>
                ...
                >
                  ...
                  <CardConfirmation>
                    ...
                    <CardButtonConfirmation>
                      <Button onClick={handleReedme} propsButton={{ ...propsButton, marginText: queryMatch.matches ? "1.2rem 0 1.2rem 1rem" : "1rem", paddingText: queryMatch.matches ? "0 0 0 2rem" : "0 0 0 0.5rem", backgroundColor: "#e9e8e8" }} tittle={"Yes"} />
                      <Button onClick={() => { handleChange(false) }} propsButton={{ ...propsButton, marginText: queryMatch.matches ? "1.2rem 0 1.2rem 1rem" : "1rem", paddingText: queryMatch.matches ? "0 0 0 2rem" : "0 0 0 0.5rem", backgroundColor: "#e9e8e8" }} tittle={"No"} />
                ...
                {hovered ?
                  <CardOverlay>
                    {isReedem ? <CardButtonConfirmation/> : null}
                    <CardDivIcon>
                      {dineroIncompleto ?
