...
export function Pagination(props) {
    ...
    return (
        <ContentPagination>
            <Button disabled={Object.entries(pagination.currentData).length < 16 || pagination.currentPage <= 1} onClick={() => { pagination.prevPage() }} propsButton={propsButtonPagination}>
